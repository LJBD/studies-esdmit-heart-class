...
using Gadfly
using StatsBase
dataId = [100, 101, 102, 103, 104, 105, 106, 107, 108, 109, 111, 112, 113, 114, 115, 117, 119, 121, 122, 123, 124, 200, 201, 202, 203, 205, 208, 209, 221, 222, 223, 230, 231, 232, 233, 234];
...
for i = 1:length(dataId)
    ...
    p = Gadfly.plot(y = clusterElements,Geom.bar, Scale.y_log10, Guide.xlabel("Numer klastra"), Guide.ylabel("Ilość reprezentantów"),Guide.title("Ilość reprezentantów poszczególnych klastrów"))
